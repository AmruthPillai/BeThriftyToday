...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "currenciesScreenSnackbarTextResetCurrenciesConfirmation" : MessageLookupByLibrary.simpleMessage("Are you sure you want to reset all currencies to the original?"),
    "currenciesScreenSnackbarTextResetCurrenciesSuccess" : MessageLookupByLibrary.simpleMessage("All currencies have been reset successfully"),
    ...
    "deleteAccountDialogContent" : MessageLookupByLibrary.simpleMessage("You will lose all the data (including profile information and your transaction history) when you delete your account. This is an irreversible process, are you sure you want to go through with it?"),
    ...
    "loginTextTagline" : MessageLookupByLibrary.simpleMessage("Be Thrifty Today is a simple and secure money management app that helps you track your income and expenses."),
    ...
    "settingsScreenSettingTitleBiometric" : MessageLookupByLibrary.simpleMessage("Biometric Security"),
    "settingsScreenSettingTitleBiometricDescription" : MessageLookupByLibrary.simpleMessage("Asks for your fingerprint every time you open the app."),
    ...
    "thriftyDrawerTextAboutFooter" : MessageLookupByLibrary.simpleMessage("If you love the app and use it regularly, please donate as little as you can, enough to keep the app alive and running on its own. You can also contribute by translating the app into your own language. Thank you so much!"),
